...
function fakeState(marker: string): NetworkStateInfo {
	return { interfaces: [{ id: marker, name: marker, medium: 'wired', link: 'up', defaultRoute: false, mac: null, addresses: [], ipv4Mode: 'dhcp', gateway: null, dns: [], configurable: true }], primaryID: marker, detail: 'full', known: true, capabilities: { ipv4: true, wifi: false } };
}

...
import { setMaxUploadSpeed, setUploadBroadcast, initUploadState, setAllowPeerList } from './protocol/lish-protocol.ts';
...
setAllowPeerList(networkSettings.allowPeerList);

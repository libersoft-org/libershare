...
export class DataServer {
	...
	/** Replace the stored LISH of the same ID atomically — see {@link replaceLISH}. */
	replace(lish: IStoredLISH): void {
		replaceLISH(this.db, lish);
	}

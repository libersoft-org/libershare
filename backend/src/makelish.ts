...
function showHelp() {
	...
	console.log('                          [UUID] will be replaced with manifest UUID');
	console.log('                          [NAME] will be replaced with manifest name (requires --name)');
...
async function main() {
	...
	// Check if [NAME] is used in output but --name is not provided
	...
	try {
		...
		// Generate UUID upfront so we can show the final output filename

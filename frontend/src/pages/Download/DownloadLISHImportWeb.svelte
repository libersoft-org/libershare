...
{:else}
	<div class="import">
		<div class="container">
			<Input bind:value={url} label={$t('downloads.lishImport.url')} placeholder="https://..." position={[0, 0]} flex />
			<div class="row">
		...
		<ButtonBar justify="center">
			<Button icon="/img/download.svg" label={$t('common.import')} position={[0, 3]} onConfirm={handleImport} disabled={loading} />

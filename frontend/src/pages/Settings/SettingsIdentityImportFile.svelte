...
{:else if browsingFilePath}
	<FileBrowser {areaID} {position} initialPath={filePath || $storageBackupPath} showPath fileFilter={['*.json']} fileFilterName={'JSON ' + $t('common.extensions')} selectFileButton onSelect={handleFilePathSelect} onBack={handleBrowseBack} />
{:else}
	<div class="import">
		<div class="container">
			<div class="row">

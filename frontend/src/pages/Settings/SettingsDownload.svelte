...
{:else}
	<div class="settings">
		<div class="container">
			...
			<div class="row" role="group" data-mouse-activate-area={areaID}>
				<Input bind:value={relayClients} label={$t('settings.download.maxRelayClients')} type="number" position={[0, 13]} flex />
				<Button icon="/img/restart.svg" position={[1, 13]} onConfirm={resetRelayClients} padding="1vh" fontSize="4vh" borderRadius="1vh" width="6.6vh" height="6.6vh" />
			</div>
			<div role="group" data-mouse-activate-area={areaID}>

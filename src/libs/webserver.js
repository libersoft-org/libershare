...
class WebServer {
 ...
 getServerConfig() {
  if (Common.settings.web && Common.settings.web.standalone) return { host: '0.0.0.0', port: Common.settings.web.port || 8000 };
  return { unix: Common.settings.web.socket_path };
 }
